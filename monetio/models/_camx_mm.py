...
def _choose_xarray_engine_and_keywords(fname):
    ...
    if fname.split(".")[-1] in netcdf_file_extensions:
...
def _add_vertical_variables(dset_chem, dset_met=None):
    """Adds relevant vertical variables if required.

    Parameters
    ----------
    dset_chem: xarray.Dataset
